...
fuse -incremental tester.tester -L unisims_ver -L unimacro_ver -L xilinxcorelib_ver -L tester=..\..\lib\tester -L test=..\..\lib\tests\%1 -L reference=..\..\lib\reference -L uut=..\..\lib\uut -o tester.exe > NUL
